...
I used a class [DataStorage.class](https://github.com/rhrmgwgeil/tradeEngine/blob/986445af9bc0bb2f61d9ac4df319e37a11759b2d/src/main/java/com/example/tradeEngine/common/DataStorage.java) to replace the database, cache server, and message queue in the project. As you can see in the file, I separated the buy order and sell order into two **ConcurrentSkipListMap** and used order price as key and a **ConcurrentSkipListSet** as value. The **ConcurrentSkipListSet** contains order information and sort ascending by order's **createTime**. To achieve thread safe, I used [CacheDistributeLock.class](https://github.com/rhrmgwgeil/tradeEngine/blob/986445af9bc0bb2f61d9ac4df319e37a11759b2d/src/main/java/com/example/tradeEngine/common/CacheDistributeLock.class) for the buy and sell queue.
